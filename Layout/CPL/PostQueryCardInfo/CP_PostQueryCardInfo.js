    ...
    function JournalPrint() {
        ...
        switch (TransType) {
                ...
                case "CWD":    
                    ...
                    //获取取款总额
                    var Amount = top.API.CashInfo.strTransAmount + ".00";
                    top.API.Jnl.Print("CashOutBox1", "JnlNum=" + JnlNum + ", TransKind=卡取款, RetCode=" + Check + ", ProResult=" + tmpstrErrMsg + ", AmountMoney=" + Amount + ", Poundage=" + Poundage);
                    break;
                case "INQ":
                    top.API.Jnl.Print("CardQuery", "JnlNum=" + JnlNum + ", TransKind=卡查询, RetCode=" + Check + ", ProResult=" + tmpstrErrMsg);
                    break;
                case "QRYCUSTNAME":
                    top.API.Jnl.Print("QueryAccInfo", "JnlNum=" + JnlNum + ", TransKind=查户名, RetCode=" + Check + ", ProResult=" + tmpstrErrMsg);
                    break;
                case "CWC":
                    top.API.Jnl.Print("WithdrawCorrect", "JnlNum=" + JnlNum + ", TransKind=取款冲正, RetCode=" + Check + ", ProResult=" + tmpstrErrMsg);
                    break;
                default:
                    if (NextPageFlag == 1) {
