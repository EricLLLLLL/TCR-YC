...
;(function () {
      ...
      var $setBtnWrap = $(".ableOrNot"),
          TransactionArr = ["Transaction19","Transaction20","Transaction21","Transaction22","Transaction23"], // 配置中需要按钮控制的项
          Transaction = "Transaction19", // 配置读取第一个参数
