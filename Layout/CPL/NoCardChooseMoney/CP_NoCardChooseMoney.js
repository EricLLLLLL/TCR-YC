...
;(function () {
    ...
    var Initialize = function () {
        EventLogin();
        lRetAuthorized = top.API.Sys.DataGetSync(top.API.MTRN_AUTHORIZEDAMOUNTRULE); // 设置授权限额
        lRetBigTranLimit = top.API.Sys.DataGetSync(top.API.MTRN_TRANLIMITAMOUNTREAL); // 交易限额
        ButtonDisable();
        ShowInfo();
    ...
    function ShowInfo() {
        ...
        var unitMaxmoney = top.API.Sys.DataGetSync(top.API.MTRN_REMAINDEPSITAMOUT); // 钞箱剩余可存金额
